...
public partial class MainPanel : UIPanelArg<SceneObjectsModel, Empty>
{
    ...
    protected override void _OnPanelInitialize()
    {
        ...
        _startButton.Pressed += () => StartGameAsync().Forget(); // Since we don't care when this function ends, Forget() is called for suppressing the compiler warning.
    ...
    private async GDTaskVoid StartGameAsync()
    {
        ...
        await _gamePanel
            ...
            .OpenPanelAsync(
                new GamePanel.OpenContext(_text, OpenArg), // Construct an instance of the open context and pass it to the game panel.
